...
def main():
    ...
    features_pos = np.load('features_pos.npy')#get_positive_features(train_path_pos, feature_params)#
    ...
    features_neg = np.load('features_neg_my.npy')
    neg_examples = np.load('neg_examples.npy')
