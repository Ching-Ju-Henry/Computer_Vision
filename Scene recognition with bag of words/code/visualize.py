...
def visualize(CATEGORIES, test_image_paths, test_labels_ids, predicted_categories_ids, train_labels_paths, train_labels_ids, con):
    ...
    panel.write('| Category name | Accuracy |Sample training images | Sample true positives | False positives with true label | False negatives with wrong predicted label |\n')
    panel.write('| :-----------: | :------: |:--------------------: | :-------------------: | :-----------------------------: | :----------------------------------------: |\n')
    ...
    for k, name in enumerate(CATEGORIES):
        ...
        panel.write('| ' + name + ' | '+ str(con[k,k])+'|'+ '![]('+train_path+')' + ' | ' + '![]('+tp_path+')' + ' | ' + '![]('+fp_path+')' + ' | ' + '![]('+fn_path+')' + ' |' + '\n')
